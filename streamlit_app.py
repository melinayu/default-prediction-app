...
person_info, cred_hist = st.columns(2)
...
with person_info:
    ...
    mstat = st.selectbox("Marital Status", options=("Married","Single","Others"), index=True, placeholder="Marital Status", label_visibility="hidden")
    edu = st.selectbox("Education", options=("Graduate School", "University", "High School", "Others"), index=True, placeholder="Education", label_visibility="hidden")
    limit_bal = st.number_input("Credit Limit", min_value=0, max_value=100000000, value=None, step=1000, placeholder="Credit Limit", label_visibility="hidden")
